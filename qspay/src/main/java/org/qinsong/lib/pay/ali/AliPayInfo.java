...
public class AliPayInfo extends PayInfo {
    ...
    public String notify_url = SDKConstants.ALI_NOTICE_URL;
...
//    注：使用该参数需要仔细阅读“花呗分期接入文档”
    ...
    public String buildParam() {
        try {
            ...
            boolean rsa2 = (SDKConstants.RSA2_PRIVATE.length() > 0);
            ...
            String privateKey = rsa2 ? SDKConstants.RSA2_PRIVATE : SDKConstants.RSA_PRIVATE;
